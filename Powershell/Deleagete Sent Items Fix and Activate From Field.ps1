...
Title: Deleagete Sent Items Fix and Activate From Field
...
if($value.Trim() -eq 3){
  Add-Type -AssemblyName System.Windows.Forms 
    ...
    Remove-ItemProperty -path "HKCU:\Software\Microsoft\Office\16.0\Outlook\Preferences" -Name "ShowFrom" -EA SilentlyContinue
    New-ItemProperty -Path "HKCU:\Software\Microsoft\Office\16.0\Outlook\Preferences" -Name "ShowFrom" -Value ”1”  -PropertyType "DWORD"
return
}
else
{
